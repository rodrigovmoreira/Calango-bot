...
export async function processQuickReplies({ userMessage, businessConfig, activeBusinessId, from, rawFrom, provider, uniqueKey, channel, cleanFromForDb, resolve, contactId }) {
...
Cliente: ${userMessage}`;
            ...
            await saveMessage(cleanFromForDb, 'bot', finalResponse, 'text', null, activeBusinessId, channel, null, rawFrom || from, contactId || null);
            return true;
        }
    }
    return false;
