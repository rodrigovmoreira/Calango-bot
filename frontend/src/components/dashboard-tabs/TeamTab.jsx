...
const TeamTab = () => {
  ...
  const isAdmin =
    state.user?.businesses?.find((b) => {
      const bId = b.businessId?._id
        ? b.businessId._id.toString()
          ...
          <ModalBody>
            <VStack spacing={4}>
              <Text fontSize="sm" color="gray.600">
                Gere um link de convite para que um novo membro entre no seu
                negócio.
              </Text>
              <FormControl>
                ...
                <Select
                  ...
                  isDisabled={isGenerating || inviteLink}
                >
                  <option value="operator">
                    Operador (Atendimento, Visualização)
                  </option>
